function h = histfitCustom(data,nbins,dist)
...
%     disp(['Lambda for red line fit in histfit is: ',num2str(pd.lambda)])
catch myException
...
q = icdf(pd,[0.0000001, .9999999995]); % CHANGED FROM [0.0013499 0.99865] three-sigma range for normal distribution
...
x(y < 0) = NaN; %avoids less-than-zero plotting
y(y < 0) = NaN;
