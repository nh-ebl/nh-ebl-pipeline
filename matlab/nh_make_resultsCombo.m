...
goodfiles = [oldgoodfields,newgoodfields,lauergoodfields];
zones = cumsum([1,length(oldgoodfields),length(newgoodfields),length(lauergoodfields)]); %Record the seperate zones and their orders
...
fieldChange_fileSkip = 15; %number of files to skip (10 sec each, 150 sec)
...
reqIDChange = ''; %detects reqID change
fieldChange_fileCntr = 1; %counter for file skip
fieldChange_fileSkip = 5; %number of files to skip (30 sec each, 150 sec)
...
%Preallocate
isgood = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mydate = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myfieldnum = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
unique_field_id = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mydataset = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mytarget = cellstr('');
mysun = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mydt = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myelong = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myexp = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myref = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myeng = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myohm = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myav = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mysig = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mymasked = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
biaslevl = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
biasmthd = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
biasdiff = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
rsolar = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myb = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mytri = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mytrierr = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mypsfwing = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myghost = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myscattering_tot = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myisl = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mydgl = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mydglerr = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myerr = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mycrr = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
mymaskmean = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myext = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myghostdiff = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myghostdifferrpos = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myghostdifferrneg = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
myghostdiffcomp = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydgl_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydglerr_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
% pltr_myohmim_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydgl_iris = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydglerr_iris = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
% pltr_myohmim_iris = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydgl_iris_sfd = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydglerr_iris_sfd = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100m_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_beta_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_temp_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_tau_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_combo_planck = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100m_iris = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_iris = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100m_iris_sfd = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_my100merr_iris_sfd = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydgl_nh = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
pltr_mydglerr_nh = zeros((numoldlightfiles+numnewlightfiles+numlauerlightfiles),1);
...
%         myohm(jfile) = data.dgl.ohmmean;
        ...
        if strcmp(flag_method,'new') == 1
            if want_errmags == 1
                ...
                myscattering_gaia_psferrneg(jfile) = data.scattered.gaiasum - data.scattered.gaiasum_psferrmin;
                myscattering_gaia_fluxerrpos(jfile) = data.scattered.gaiasum_fluxerrmax - data.scattered.gaiasum;
                myscattering_gaia_fluxerrneg(jfile) = data.scattered.gaiasum - data.scattered.gaiasum_fluxerrmin;
                ...
                myscattering_masana_psferrneg(jfile) = data.scattered.masanasum - data.scattered.masanasum_psferrmin;
                myscattering_masana_fluxerrpos(jfile) = data.scattered.masanasum_fluxerrmax - data.scattered.masanasum;
                myscattering_masana_fluxerrneg(jfile) = data.scattered.masanasum - data.scattered.masanasum_fluxerrmin;
            end
        end
...
jfile = 1+numoldlightfiles+numnewlightfiles;
% k = k + 1;
zones_indexer = zones_indexer + 1; %Increment the zone to the next zone of data
zones_goodfiles = goodfiles(zones(zones_indexer):zones(zones_indexer+1)-1); %Current zone's good fields
for ifile=1:numel(llightfiles)
