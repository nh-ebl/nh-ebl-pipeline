function nh_stack_psf()
  ...
  load(sprintf('%s2454110.6998537.mat',paths.datadir));
  
  load(sprintf('%sfield_14_data.mat',paths.catdir));
  ...
  load(sprintf('%s2453978.8117112.mat',paths.datadir));
  
  zoommap = data.data(17:41,23:47);
