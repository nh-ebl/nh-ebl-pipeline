...
% and compares to find relationship
% Symons, May 2019
%
...
%                  elseif (brightmag(ifile,1)<6)
%                     g3= scatter(199+data.ghost.ghostx,199+(256-data.ghost.ghosty),'g','filled');
%                    hold on;
%                     scatter(starxadj(ifile,1),staryadj(ifile,1),'g','filled');
%                  elseif (brightmag(ifile,1)>6)
