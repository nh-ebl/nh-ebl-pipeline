...
%     if strcmp(timestamp,'2458731.2935809') == 1
        ...
        % If phase name has 9 characters
        if strcmp(subfile(1:9),'kemcruise')
            darkpre = subfile(11:25);
            darkpst = subfile(27:47);
            % If phase name has 7 characters
        elseif strcmp(subfile(1:7),'jupiter')
        ...
        elseif strcmp(subfile(1:5),'pluto') || strcmp(subfile(1:5),'OE394') || strcmp(subfile(1:5),'OJ394') || strcmp(subfile(1:5),'ZL138')
            ...
            % If phase name has 3 characters
        elseif strcmp(subfile(1:3),'kem')
            darkpre = subfile(5:19);
            darkpst = subfile(21:41);
        end
