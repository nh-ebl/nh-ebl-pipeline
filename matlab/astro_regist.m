...
for i=1:Ncols
    ...
    inst = 1;
    solf(1).defrad = '1'; % Set radius to 1 degree
    ...
    %/usr/local/astrometry-0.85new/bin/ location of newer version
    solfcall = sprintf(...
        ['solve-field %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s '...
        ' %s %f %s %f %s %s %s %s %s %s %s'],...
        solf(inst).overwrite,solf(inst).noplots,solf(inst).guesson,solf(inst).verifyoff,...
...
%     solf(inst).strscalehigh,solf(inst).scalehigh,...
%     solf(inst).strscaleunits,solf(inst).scaleunits,...
%     solf(inst).depth,solf(inst).numstars,...
%     solfcall = sprintf(...
%     ['solve-field %s %s %s %s %s %s %s %s %s %s %s %s '...
%     ' %s %f %s %f %s %s %s %s %s %s %s'],...
%     solf(inst).overwrite,...
%     solf(inst).noplots,...
%     solf(inst).guesson,...
