function catalog_data_gaia(gals)
...
for i=1:n
    ...
    if gals == 0
        ...
        gal_data = readtable(sprintf('%sgal_files/gaiagal_field_%d.txt',paths.gaiadir,i),'Delimiter','\t','HeaderLines',46);
    ...
    save(sprintf('%smat_files/field_%d_data', paths.gaiadir,i), 'RA', 'DEC', 'Gmag');
