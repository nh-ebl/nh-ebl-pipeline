...
iris_prop_err = sqrt((([iris_err;iris_err;iris_err;iris_err].*dl).^2) + (dberr.*(pltr_my100m_iris_goodfiles.^2)));
iris_sfd_prop_err = sqrt((([iris_err;iris_err;iris_err;iris_err].*dl).^2) + (dberr.*(pltr_my100m_iris_sfd_goodfiles.^2)));
...
i1errx = errorbar(pltr_my100m_iris_goodfiles.*dl,pltr_thissig_goodfiles,[iris_err;iris_err;iris_err;iris_err].*dl,'horizontal', 'LineStyle','none','Color', 'g');
...
i2errx = errorbar(pltr_my100m_iris_sfd_goodfiles.*dl,pltr_thissig_goodfiles,[iris_err;iris_err;iris_err;iris_err].*dl,'horizontal', 'LineStyle','none','Color', 'm');
...
% hold on
% n1errx = errorbar(pltr_mydgl_nh_goodfiles,pltr_thissig_goodfiles,[hi4pi_err;hi4pi_err;hi4pi_err;hi4pi_err],'horizontal', 'LineStyle','none','Color', 'k');
% n1erry = errorbar(pltr_mydgl_nh_goodfiles,pltr_thissig_goodfiles,pltr_sem,'vertical', 'LineStyle','none','Color', 'k');
% 
% % make fit
% % NHI
% [b_nh, m_nh, sigm_nh, sigb_nh, chi2, q] = fitexy(pltr_mydgl_nh_goodfiles, pltr_thissig_goodfiles, [hi4pi_err;hi4pi_err;hi4pi_err;hi4pi_err], pltr_sem)
...
% now load old data to combine with new data
paths = get_paths_old();
