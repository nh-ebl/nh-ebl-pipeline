...
ax.annotate(r'HDF/SDF',xy=(0.0,0.0),xytext=(0.685,0.47),xycoords='figure fraction',textcoords='figure fraction',rotation=0,color='black',fontsize=10)
...
ax.annotate(r'STIS',xy=(0.0,0.0),xytext=(0.165,0.3),xycoords='figure fraction',textcoords='figure fraction',rotation=360+0,color='black',fontsize=10)
...
ax.annotate(r'HESS $\gamma$-rays',xy=(0.0,0.0),xytext=(0.6,0.59),xycoords='figure fraction',textcoords='figure fraction',rotation=360+20,color='black',fontsize=10)
...
ax.annotate(r'WFPC2',xy=(0.0,0.0),xytext=(0.36,0.77),xycoords='figure fraction',textcoords='figure fraction',rotation=0,color='black',fontsize=10)
...
ax.annotate(r'DIRBE',xy=(0.0,0.0),xytext=(0.82,0.75),xycoords='figure fraction',textcoords='figure fraction',rotation=0,color='black',fontsize=10)
...
ax.annotate(r'CIBER',xy=(0.0,0.0),xytext=(0.70,0.69),xycoords='figure fraction',textcoords='figure fraction',rotation=0,color='black',fontsize=10)
...
# LORRI
ax.plot(np.asarray([0.440,0.870]),np.asarray([4.7,4.7]),color='red',linestyle='--',linewidth=0.5)
eb1=ax.errorbar(np.asarray([0.655,0.655]),np.asarray([4.7,4.7]),yerr=np.asarray([7.3,7.3]),marker='*',color='red',linewidth=0.5,markersize=10,markerfacecolor='red',markeredgecolor='none')
eb1[-1][0].set_linestyle('--')
ax.plot(np.asarray([0.440,0.870]),np.asarray([19.3,19.3]),color='red',linestyle='-',linewidth=2)
ax.errorbar([(0.44+0.870)/2],[19.3],yerr=6, uplims=True,color='red',linewidth=2)
...
x=[0.2,0.3,0.4,0.5,0.7,1.0,1.5,2.0]
labels=['0.2','0.3','0.4','0.5','0.7','1.0','1.5','2.0']
